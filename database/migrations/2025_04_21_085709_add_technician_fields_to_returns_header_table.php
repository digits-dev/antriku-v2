...
class AddTechnicianFieldsToReturnsHeaderTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('returns_header', function (Blueprint $table) {
            $table->dropColumn(['case_status','lead_technician_id', 'technician_id', 'technician_assigned_at', 'technician_accepted_at']);
        });
    }
}
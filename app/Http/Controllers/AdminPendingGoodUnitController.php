<?php namespace App\Http\Controllers;
	...
	class AdminPendingGoodUnitController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			// $this->form[] = ['label'=>'Call Out Mail In At','name'=>'call_out_mail_in_at','type'=>'datetime','validation'=>'required|date_format:Y-m-d H:i:s','width'=>'col-sm-10'];
			// $this->form[] = ['label'=>'Call Out Mail In By','name'=>'call_out_mail_in_by','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			// $this->form[] = ['label'=>'Mail In Shipped At','name'=>'mail_in_shipped_at','type'=>'datetime','validation'=>'required|date_format:Y-m-d H:i:s','width'=>'col-sm-10'];
			// $this->form[] = ['label'=>'Mail In Shipped By','name'=>'mail_in_shipped_by','type'=>'datetime','validation'=>'required|date_format:Y-m-d H:i:s','width'=>'col-sm-10'];
			...
			// $this->form[] = ['label'=>'Ongoing Repair At','name'=>'ongoing_repair_at','type'=>'datetime','validation'=>'required|date_format:Y-m-d H:i:s','width'=>'col-sm-10'];
			// $this->form[] = ['label'=>'Ongoing Repair By','name'=>'ongoing_repair_by','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			// $this->form[] = ['label'=>'Pending Spare Parts At','name'=>'pending_spare_parts_at','type'=>'datetime','validation'=>'required|date_format:Y-m-d H:i:s','width'=>'col-sm-10'];
			// $this->form[] = ['label'=>'Pending Spare Parts By','name'=>'pending_spare_parts_by','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			// $this->form[] = ['label'=>'Receipt','name'=>'receipt','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Call Out Mail In At","name"=>"call_out_mail_in_at","type"=>"datetime","required"=>TRUE,"validation"=>"required|date_format:Y-m-d H:i:s"];
			//$this->form[] = ["label"=>"Call Out Mail In By","name"=>"call_out_mail_in_by","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			...
			//$this->form[] = ["label"=>"Mail In Shipped At","name"=>"mail_in_shipped_at","type"=>"datetime","required"=>TRUE,"validation"=>"required|date_format:Y-m-d H:i:s"];
			//$this->form[] = ["label"=>"Mail In Shipped By","name"=>"mail_in_shipped_by","type"=>"datetime","required"=>TRUE,"validation"=>"required|date_format:Y-m-d H:i:s"];
			...
			//$this->form[] = ["label"=>"Ongoing Repair At","name"=>"ongoing_repair_at","type"=>"datetime","required"=>TRUE,"validation"=>"required|date_format:Y-m-d H:i:s"];
			//$this->form[] = ["label"=>"Ongoing Repair By","name"=>"ongoing_repair_by","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			...
			//$this->form[] = ["label"=>"Pending Spare Parts At","name"=>"pending_spare_parts_at","type"=>"datetime","required"=>TRUE,"validation"=>"required|date_format:Y-m-d H:i:s"];
			//$this->form[] = ["label"=>"Pending Spare Parts By","name"=>"pending_spare_parts_by","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			...
			//$this->form[] = ["label"=>"Receipt","name"=>"receipt","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
	    ...
	    */    
		public function hook_row_index($column_index,&$column_value) {	        
			...
			if($column_index == 1){
				if($column_value == $pending_good_unit->id){
					$column_value = '<span class="label label-info">'.$pending_good_unit->status_name.'</span>';
				}
			}
			if($column_index == 3){

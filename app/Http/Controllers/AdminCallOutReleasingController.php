...
class AdminCallOutReleasingController extends \crocodicstudio\crudbooster\controllers\CBController
{
	...
	public function hook_query_index(&$query)
	{
		if (CRUDBooster::myPrivilegeId() == 3) {
			$query->whereIn('repair_status', [13,19,22,28,38])->where('branch', CRUDBooster::me()->branch_id);
		} else {
			$query->whereIn('repair_status', [13,19,22,28,38]);
		}
	}

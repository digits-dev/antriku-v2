<?php namespace App\Http\Controllers;
	...
	class AdminPickUpController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Returns Status","name"=>"repair_status"];
			...
			$this->col[] = ["label"=>"Diagnostic Cost","name"=>"diagnostic_cost"];

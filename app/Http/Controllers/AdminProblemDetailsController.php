<?php namespace App\Http\Controllers;
	...
	class AdminProblemDetailsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Problem Details','name'=>'problem_details','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-7'];

<?php namespace App\Http\Controllers;
	...
	class AdminStockDisposalLinesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Parts Item Master Id","name"=>"parts_item_master_id","type"=>"select2","required"=>TRUE,"validation"=>"required|min:1|max:255","datatable"=>"parts_item_master,id"];
			//$this->form[] = ["label"=>"Qty","name"=>"qty","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Stock Disposal Header Id","name"=>"stock_disposal_header_id","type"=>"select2","required"=>TRUE,"validation"=>"required|min:1|max:255","datatable"=>"stock_disposal_header,id"];

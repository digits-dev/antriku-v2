    ...
    <div class="col-md-12">
        ...
        <div class="upload-receipt">
                <div class="upload-card">
                    <span class="header">Upload Final Invoice</span>
                    <p> Upload image (Invoice).</p>
                    <div class="upload-file-container">
                        <label for="final_invoice" id="drop-area-final-invoice">
                            <input required id="final_invoice" name="final_invoice" type="file" accept="image/*"
            ...
            <div class="preview" id="preview">
                <span class="header">Final Invoice Image Preview</span>
                <p>View and verify your Final invoice image before uploading</p>
                <div class="image-preview" id="image-preview">
                    <div id="no-receipt-message" style="font-size: 14px; color: #777;">
                        ...
                        <p>
                            Upload an Final invoice using the form on the left to see a preview here
                        </p>
                    </div>
                </div>
...
@else
    @if (!is_null($transaction_details->final_invoice))
    <div class="row">
        <div class="col-md-12">
            <div class="row"> 
                <div class="col-md-12">
            ...
            <div class="card-body-cust">
                <div class="info-label-cust">Final Invoice</div>
                <div class="uploaded-image-container">
                    <img class="uploaded-image" src="{{ Storage::url('final_invoice/' . $transaction_details->final_invoice) }}" alt="final_invoice">
                </div>
            </div>
        </div>
    </div>
...
@push('bottom')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            const inputFileRPF = $("#final_invoice");
        ...
        $('#drop-area-final-invoice').on('dragover', function(e) {
            e.preventDefault();
            dropArea.addClass("drag-over");
        })
        $('#drop-area-final-invoice').on("dragleave", function(e) {
            e.preventDefault();
            dropArea.removeClass("drag-over");
            imageView.removeClass("drag-over");
        });

        $('#drop-area-final-invoice').on('drop', function(e) {
            e.preventDefault();
            dropArea.removeClass("drag-over"); 
            imageView.addClass("drag-over"); 

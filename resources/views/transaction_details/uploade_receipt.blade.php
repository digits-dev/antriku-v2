...
@if(request()->segment(3) == "edit" && in_array($transaction_details->repair_status, [17]))
<div class="row">
    <div class="col-md-12">
        <div class="row"> 
            <div class="col-md-12">
        ...
        <div class="upload-receipt">
            <div class="upload-card">
                <span class="header">Upload Receipt</span>
                <p>Upload the receipt as proof of payment and confirmation.</p>
                <div class="upload-file-container">
                    <label for="input-file" id="drop-area">
                        <input required id="input-file" name="receipt" type="file" accept="image/*"
            ...
            <div class="preview" id="preview">
                <span class="header">Receipt Preview</span>
                <p>View and verify your receipt before uploading</p>
                <div class="image-preview" id="image-preview">
                    <div id="no-receipt-message" style="font-size: 14px; color: #777;">
                        ...
                        <p>
                            Upload a receipt using the form on the left to see a preview here
                        </p>
                    </div>
                </div>
...
@else
    @if (!is_null($transaction_details->receipt))
    <div class="row">
        <div class="col-md-12">
            <div class="row"> 
                <div class="col-md-12">
            ...
            <div class="uploaded-image-container">
                <img class="uploaded-image" src="{{ Storage::url('receipts/' . $transaction_details->receipt) }}" alt="Receipt">
            </div>
        </div>
    </div>
    @endif

  ...
  <main class="container-dash dashboard-dash" style="margin-top: 50px;">
                          ...
                          <div class="row">
                                  ...
                                  <div class="m-dash-card m-dash-default clickable_card1" id="clickable_card1"
                                      ...
                                      <div class="m-dash-card-header" style="margin: 0">
                                          <div class="m-dash-card-title">
                                            <i class="bi bi-clipboard2-check-fill" style="background: #948979; color:white; padding: 4px 5px 4px 5px; border-radius: 7px;"></i>
                              ...
                              <div class="col-md-4">
                                  ...
                                  <div class="m-dash-card m-dash-default clickable_card1" id="clickable_card1"
                                      ...
                                      <div class="m-dash-card-value" id="filtered-callouts-value">
                                          {{ count($totalAwaitingRepair) ?? 0 }}
                                      </div>
                                      <div class="m-dash-card-change m-dash-col-default">
                                          {{-- -10% from yesterday --}}
                                      </div>
                                  </div>
                              </div>
                                          ...
                                          <table class="transactions-table" autofocus>
                                              ...
                                              <tbody style="text-align: left; background: rgba(240, 246, 247, 0.7);">
                                                  @php
                                                    ...
                                                    mergeData($allData, $totalAwaitingRepair, 'awaiting');
      ...
      <div id="model_section" class="tab-content-dash">
          ...
          <div class="dashboard-grid-dash">
              <div class="card-dash" style="border-top-left-radius: 0px; border-top-right-radius: 0px;">
                  <div class="card-body-dash">
    ...
    $(document).ready(function() {
        $('.clickable_card1').on('click', function() {
            ...
            if (title === 'My Ongoing Diagnosis') {
                status = 'diagnosing';
            } else if (title === 'Ongoing Repair Cases (Carry In)') {
                status = 'repairing';
            } else if (title === 'Awaiting Repair Cases (Mail In)') {
                status = 'awaiting';
            }

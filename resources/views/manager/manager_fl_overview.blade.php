        ...
        <div class="row">
            <div class="col-md-12">
                <div class="m-dash-card m-dash-default" data-cardname="Pending Call-Outs"style="cursor: pointer;">
                    ...
                    <div class="m-dash-card-value" id="fl_pending_call_out_vmall">
                        {{ count($fl_pending_call_out_vmall) ?? 0 }}
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="m-dash-card m-dash-default" data-cardname="Pending Call-Outs"style="cursor: pointer;">
                    ...
                    <div class="m-dash-card-value" id="fl_abandoned_units_vmall">
                        {{ count($fl_abandoned_units_vmall) ?? 0 }}
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="transactions-container">
                    ...
                    <div class="card-body-dash" style="margin: 0%">
                        <div class="chart-container" style="position: relative; height: 428px; width: 100%; display: flex; flex-direction: column; align-items: center; padding: 10px 0;">
                        <canvas id="aging_callout" height="200"></canvas>
                        </div>
                    </div>
                </div>           
            </div>
    ...
    <div class="col-md-9">
        <div class="transactions-container">
            ...
            <div class="card-body-dash" style="margin: 0%">
                <div class="chart-container" style="position: relative; height: 280px; width: 100%; display: flex; flex-direction: column; align-items: center; padding: 10px 0;">
                <canvas id="aging_callout_types" height="200"></canvas>
                </div>
            </div>
        </div>           
    </div>
    ...
    <div class="col-md-9">
        <br>
        <div class="transactions-container summary-data-all">
            <div class="transactions-header" style="margin: 0%">
                ...
                <table class="transactions-table" autofocus>
                    ...
                    <tbody style="text-align: left; background: rgba(240, 246, 247, 0.7);">
                        @php
                            ...
                            function mergeData(&$flAllData, $collection, $label) {
                            ...
                            mergeData($flAllData, $fl_pending_call_out_vmall, 'fl-pending-callout');
                            mergeData($flAllData, $fl_abandoned_units_vmall, 'fl-abandoned-unit');
                        @endphp
        ...
        <div class="transactions-container pending-call-out-fl" style="display: none">
            <div class="transactions-header" style="margin: 0%">
                <h2 class="card-title-dash">
                    <div class="card-icon-dash icon-default">
                        <i class="bi bi-table" style="font-size: 12px"></i>
            ...
            <div style="height: 295px; overflow: auto;">
                <table class="transactions-table" autofocus>
                    ...
                    <tbody style="text-align: left; background: rgba(240, 246, 247, 0.7);">
                        @foreach ($fl_pending_call_out_vmall as $item)
                            <tr>
                                <td style="font-size: 12px">{!! $item->reference_no ?? '<small class="m-dash-negative">Empty Data</small>' !!}</td>
                                <td style="font-size: 12px">{!! $item->warranty_status ?? '<small class="m-dash-negative">Empty Data</small>' !!}</td>
                                <td style="font-size: 12px">{!! $item->case_status ?? '<small class="m-dash-negative">Empty Data</small>' !!}</td>
        ...
        <div class="transactions-container abandoned-unit-fl" style="display: none">
            <div class="transactions-header" style="margin: 0%">
                <h2 class="card-title-dash">
                    <div class="card-icon-dash icon-default">
                        <i class="bi bi-table" style="font-size: 12px"></i>
            ...
            <div style="height: 295px; overflow: auto;">
                <table class="transactions-table" autofocus>
                    ...
                    <tbody style="text-align: left; background: rgba(240, 246, 247, 0.7);">
                        @foreach ($fl_abandoned_units_vmall as $item)
                            <tr>
                                <td style="font-size: 12px">{!! $item->reference_no ?? '<small class="m-dash-negative">Empty Data</small>' !!}</td>
                                <td style="font-size: 12px">{!! $item->warranty_status ?? '<small class="m-dash-negative">Empty Data</small>' !!}</td>
                                <td style="font-size: 12px">{!! $item->case_status ?? '<small class="m-dash-negative">Empty Data</small>' !!}</td>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        document.getElementById('fl_pending_call_out_vmall').addEventListener('click', function () {
            document.querySelector('.pending-call-out-fl').style.display = 'block';
            document.querySelector('.abandoned-unit-fl').style.display = 'none';
            document.querySelector('.summary-data-all').style.display = 'none';
        });

        document.getElementById('fl_abandoned_units_vmall').addEventListener('click', function () {
            document.querySelector('.abandoned-unit-fl').style.display = 'block';
            document.querySelector('.pending-call-out-fl').style.display = 'none';
            document.querySelector('.summary-data-all').style.display = 'none';
        });
    });
</script>

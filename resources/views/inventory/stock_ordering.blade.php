            ...
            searchTimeout = setTimeout(function() {
                ...
                if (filtered.length === 0) {
                    ...
                    let resultsHTML = filtered.map(item => `
                        <div class="result-item" data-name="${item.spare_parts}" data-desc="${item.item_description}" data-cost="${item.cost}">
        ...
        $(document).on('click', '.result-item', function () {
            ...
            let newRow = `
                <tr>
                    ...
                    <td><input type="text" class="price-input" value="${formattedCost}"></td>
